...
public class Sports extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "ICC Cricket World Cup", "FIFA WorldCup", "NBA Finals 2015", "TNA Impact", "WWE Raw", "UFC championship", "WimBledon 2015", "The Olympic Games", "English Premier League 2014", "La Liga 2014", " " };
        ...
        if(jTextField4.getText().equals(avail)){
            ...
            if(file.exists()){
                ...
                try {
                    ...
                    br.write(jTextField1.getText()+" "+"Rs.400");
                    br.newLine();
                    br.close();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        jTextField3.setText("Type: Sports");
        if(i%2==0){
